...
public class zhuce extends AppCompatActivity {
    ...
    MysqlHe mysqlHe=new MysqlHe(zhuce.this);
        @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public boolean isUserExist(String name){
                    ...
                    MysqlHe sqlhe=new MysqlHe(zhuce.this);
                ...
                public void onClick(View v) {
                    ...
                    if (isUserExist(username)){
                        Toast.makeText(zhuce.this, R.string.userno, Toast.LENGTH_SHORT).show();
                    }else {
                        //isEmpty,判断非空
                    if (username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()) {
                        Toast.makeText(zhuce.this, R.string.use, Toast.LENGTH_SHORT).show();
                    } else if (!password.equals(confirmPassword)) {
                        Toast.makeText(zhuce.this, R.string.mandm, Toast.LENGTH_SHORT).show();
                    } else if (!password.matches("^(?=.*[a-zA-Z])(?=.*\\d)[a-zA-Z\\d]{8,}$")) {
                        Toast.makeText(zhuce.this, R.string.pwd, Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        finish();
                        //保留账号到登录页
                        Intent intent = new Intent(zhuce.this, RegisterActivity.class);
